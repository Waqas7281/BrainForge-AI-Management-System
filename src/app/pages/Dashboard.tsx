...
import { Users, GraduationCap, UserCheck, BookOpen, TrendingUp, TrendingDown } from 'lucide-react';
...
const recentActivities = [
  { id: 1, action: 'New student enrolled', student: 'John Smith', time: '5 minutes ago' },
  { id: 2, action: 'Assignment submitted', student: 'Emma Wilson', time: '12 minutes ago' },
  { id: 3, action: 'Fee payment received', student: 'Michael Brown', time: '1 hour ago' },
  { id: 4, action: 'Teacher marked attendance', student: 'Class 10-A', time: '2 hours ago' },
  { id: 5, action: 'New notice published', student: 'Annual Day Event', time: '3 hours ago' },
];
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-1 mt-2">
                    ...
                    <span className="text-gray-500" style={{ fontSize: 'var(--text-small)' }}>
                      vs last month
                    </span>
                  </div>
                </div>
            ...
            {classDistribution.map((item) => (
              <div key={item.name} className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700" style={{ fontSize: 'var(--text-body)' }}>{item.name}</span>
                </div>
          ...
          <div className="space-y-4">
            {recentActivities.map((activity) => (
              <div key={activity.id} className="flex items-start gap-3 pb-4 border-b border-gray-200 last:border-0">
                ...
                <div className="flex-1">
                  <p className="text-gray-900" style={{ fontSize: 'var(--text-body)' }}>
                    {activity.action}
                  </p>
