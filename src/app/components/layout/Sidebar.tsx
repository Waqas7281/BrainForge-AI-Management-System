...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        w-60 bg-white border-r border-gray-300 h-screen sticky top-0 flex flex-col z-50
        fixed lg:static
      ...
      `}>
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-gray-300">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-900" style={{ fontSize: 'var(--text-h4)' }}>
              EduManage
            </span>
          </div>
          <button
              ...
              return (
                <li key={item.path}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: 'var(--text-body)' }}>{item.label}</span>
                  </NavLink>
                </li>
              );
            })}
        ...
        <div className="p-4 border-t border-gray-300">
          <div className="text-center" style={{ fontSize: 'var(--text-tiny)', color: 'var(--gray-500)' }}>
            © 2026 EduManage
          </div>
        </div>
      </aside>
